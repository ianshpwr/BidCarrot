...
export default function Stepper({
  ...
  return (
    <div
      className="flex min-h-full flex-1 flex-col items-center justify-center p-4 text-white sm:aspect-[4/3] md:aspect-[2/1]"
      {...rest}
    >
      <div
        className={`mx-auto w-full max-w-md rounded-4xl shadow-xl bg-black ${stepCircleContainerClassName}`}
      ...
      >
        ...
        <StepContentWrapper
          ...
          currentStep={currentStep}
          direction={direction}
          className={`space-y-2 px-8 text-white ${contentClassName}`}
        >
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: "#1a1a1a", color: "#888" },
          active: { scale: 1, backgroundColor: "#00d8ff", color: "#060606" },
          complete: { scale: 1, backgroundColor: "#00d8ff", color: "#1a1a1a" },
        }}
